  ...
  return (
    <section id="home" className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black flex items-center justify-center relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        <div className="mb-8">
          {/* Large Clan Logo */}
          <div className="w-32 h-32 mx-auto mb-6 bg-gray-800 border-4 border-emerald-400 rounded-2xl flex items-center justify-center overflow-hidden shadow-2xl">
            <img 
              src={pwkLogo} 
          ...
          <h1 className="text-5xl md:text-7xl font-bold text-white mb-4">
            <span className="text-emerald-400">PWK</span> Esports
          </h1>
          <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-3xl mx-auto">
            Champions of the Virtual Pitch. Join the most competitive eFootball clan and dominate the leagues.
          </p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
          ...
          <button className="border border-gray-600 hover:border-emerald-400 text-gray-300 hover:text-emerald-400 px-8 py-3 rounded-lg font-semibold transition-colors duration-200 flex items-center justify-center space-x-2" 
